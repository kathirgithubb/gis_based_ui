...
import AssignerPanelPage from './AssignerPanelPage';
...
// // BLACK_GREY — RESPONSIVE v5 (mobile editor-safe controls + mobile logo + smaller zoom/compass)
...
//   }, [showOC, selectedObjectId, showBottomPanel]);
...
//   /* layout helpers */
//   const topLeftLeft = !isMobile && showOC ? 266 : 14;
//   const botLeftLeft = !isMobile && showOC ? 282 : 14;
...
//             <input
//               className="w-full bg-transparent text-[12px] text-[#111] outline-none placeholder:text-[#888]"
//               placeholder="Search asset, pole, address..."
//             />
//           </div>
//         </div>

//         {showTopMenu && (
//           <div className="absolute left-0 top-10 sm:top-11 z-50 min-w-[170px] overflow-hidden rounded-xl border border-[#c8c8c8] bg-[#e8e8e8] shadow-lg">
//             {[
//               {
//                 label: 'Home',
//                 action: () => {
...
//                 type="button"
//                 onClick={item.action}
//                 className={`flex w-full items-center px-4 py-2.5 text-left text-[13px] text-[#111] hover:bg-[#d4d4d4] ${
...
//         style={{ width: isMobile ? 'min(72vw,230px)' : '250px' }}
//       >
...
//           <button type="button" onClick={() => setShowOC(false)} className={`${ib} h-6 w-6 rounded-md text-xs font-bold`}>
//             ←
//           </button>
//         </div>
...
//                 className="flex w-full items-center justify-between rounded-lg px-2.5 py-1.5 text-left font-medium text-[#111] hover:bg-[#d4d4d4] transition-all"
//               >
//                 <span className="text-[13px]">{group.key}</span>
//                 <span className="text-[10px]">{expandedGroups[group.key] ? '▾' : '▸'}</span>
//               </button>
...
//                       className={`block w-full rounded-md px-2.5 py-1.5 text-left text-[12px] transition-all
//                         ${
...
//             <div className="text-[12px] font-semibold text-[#111] mr-auto truncate shrink-0">
//               {selectedObjectItem ? `${selectedObjectItem} Table` : 'Objects'}
//             </div>
...
//             <button type="button" onClick={() => setAppliedTableFilter(tableFilterInput)} className={`${pb} h-7 rounded-md px-2.5 text-[11px] font-semibold`}>
//               Run
//             </button>

//             <button type="button" onClick={downloadTable} className={`${gb} h-7 rounded-md px-2.5 text-[11px] font-semibold`}>

//             Download
//             </button>

//             <button onClick={() => setShowBottomPanel(false)} className={`${ib} h-7 w-7 rounded-md text-xs font-bold`}>
//               ↓
//             </button>
//           </div>
...
//                     <th key={h} className="truncate px-2 py-[3px] font-semibold whitespace-nowrap">
//                       {h}
//                     </th>
//                   ))}
//                 </tr>
